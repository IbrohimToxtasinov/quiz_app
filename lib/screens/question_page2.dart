...
class QuestionPage2 extends StatefulWidget {
  const QuestionPage2({Key? key, questions}) : super(key: key);
...
class _QuestionPage2State extends State<QuestionPage2> {
  ...
  void initState() {
    ...
    QuestionModel.UzbekistanHistory.map((q) {
        ...
        children: [
          ...
          ProgressWidget(
            currentWidth: (MediaQuery.of(context).size.width * 0.78) *
                ((currentQuestionIndex + 1) / QuestionModel.UzbekistanHistory.length),
          ),
          SizedBox(height: 12),
          Stack(
            children: [
          ...
          QuestionWidget(
            questionTitle:
                QuestionModel.UzbekistanHistory[currentQuestionIndex].question,
          ...
          AnswersWidget(
            ...
            questionModel: QuestionModel.UzbekistanHistory[currentQuestionIndex],
          ),
  ...
  nextQuestion() {
    setState(() {
      ...
      if (currentQuestionIndex != QuestionModel.UzbekistanHistory.length - 1) {
        start = 15;
